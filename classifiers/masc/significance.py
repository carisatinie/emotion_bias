...
def main(feature_type, writer):
  ...
  train_both = "../../final_data/masc/train_masc_2.csv"
  feature_both = "../../analysis/new_masc_tukey_b_features.csv"
  ...
  if feature_type == 'corr':
    ...
    # validation
    val_model_female = get_model(train_female, feature_idxs_female, 18, 0.00001)
    val_model_male = get_model(train_male, feature_idxs_male, 20, 0.000001)
    val_model_both = get_model(train_both, feature_idxs_both, 18, 0.00001)
    ...
    # validation
    val_model_female = get_model(train_female, feature_idxs_female, 18, 0.000001)
    val_model_male = get_model(train_male, feature_idxs_male, 18, 0.00001)
...
if __name__ == "__main__":
  ...
  chi_squared_file = open("masc_chisquared.csv", "w")
