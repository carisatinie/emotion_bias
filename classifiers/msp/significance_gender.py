...
'''
MSP: statistical tests to determine feature set bias.
...
def main(feature_type):
  ...
  parameters = [(10, 0.1), (25, 0.01), (20, 0.0000001), (10, 0.000001), (20, 0.00001)]
  ...
  parameters = [(10, 0.01), (20, 0.001), (10, 0.000001), (18, 0.000001), (10, 0.01)]
  global rf_final
  rf_final = None
